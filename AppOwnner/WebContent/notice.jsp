<%@page import="com.appowner.bean.NoticeBoardBean"%>
    ...
    <form id="ponyo_form" action="srv" method="post">
        ...
        <table border="0" width="35%" align="center">
            ...
            <tr>
                ...
                <td><input type="text" name="recipient" size="50" value="<%=NoticeBoardBean.getMailids()%>"/></td>
            </tr>

            <tr>
                <td>Subject </td>
                <td><input type="text" name="subject" size="50" value="<%=NoticeBoardBean.getSubject()%>"/></td>
            </tr>
            <tr>
                <td>Content </td>
