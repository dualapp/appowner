...
<body>
 <%System.out.println("zzzzzzzzzzzzzzzzzzzzzzzzzz7777777777777777778888888888888888888888888888888zzzzzzzzzzzzzzzzzzzzzzzzz");%>
...
<iframe id="ponyo_frame" name="ponyo_frame"></iframe>
    ...
    <form id="ponyo_form" action="srv" method="post">
        ...
        <table border="0" width="35%" align="center">
            ...
            <tr>
                <td>Subject </td>
                <td><input type="text" name="subject" size="50" value="<%=ScriptBean.getSubject()%>"/></td>
            </tr>
            <tr>
                <td>Content </td>
